...
/*   Updated: 2018/09/28 19:16:15 by mdambrev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <nm_otool.h>

int						if_equal_fat(void *ptr,
									off_t offset_end, struct stat *buf)
{
	void				*data_end;
	void				*fat_end;
...
int						check_fat_corrupt(void *ptr,
										struct stat *buf, char *str)
{
