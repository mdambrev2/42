...
/*   Updated: 2018/09/28 19:43:47 by mdambrev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <nm_otool.h>

int							if_equal_x32(void *ptr,
								struct segment_command *seg, struct stat *buf)
{
	void					*data_end;
	void					*seg_data_end;
...
int							check_size_corrupt_x32(void *ptr,
												struct stat *buf, int y)
{
...
int							if_equal_x64(void *ptr,
							struct segment_command_64 *seg, struct stat *buf)
{
	void					*data_end;
	void					*seg_data_end;
...
int							check_size_corrupt_x64(void *ptr,
													struct stat *buf, int y)
{
