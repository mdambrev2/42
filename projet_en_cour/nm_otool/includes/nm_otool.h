...
void					unzip_ar(void *ptr, void *name, int ac,
								struct stat *buf);
...
void					unzip_fat_otool(void *ptr, void *name, int ac,
										struct stat *buf);
int						check_x32_x64_corrupt(void *ptr, struct stat *buf,
												char *str, int x);
int						put_corrupted_files(char *str);
int						put_wrong_command_size(char *str);
int						check_fat_corrupt(void *ptr, struct stat *buf,
											char *str);
...
char					*add_octet_otool_32(char *str, int strlen,
														int n_ret);
